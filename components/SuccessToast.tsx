...
const SuccessToast : FC<Props> = ({openToast}) => {
  return(
    <div id="toast-success"
         className={`${openToast ? "block " : "hidden"} flex absolute bottom-5 items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 `}
         role="alert">
      <div
