    ...
    <form>
      ...
      <div className="relative">
        ...
        <input id="default-search"
          ...
          <button type="submit"
                  className="text-white absolute right-2.5 bottom-2.5 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  dark:focus:ring-blue-800">
